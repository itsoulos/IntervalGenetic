...
# Template: app
# Command: /usr/bin/qmake -o Makefile IntervalGenetic.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -O3 -Wl,-O1
LIBS          = $(SUBLIBS) -lm -fopenmp /usr/lib/libQt5Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/modules/qt_TextAutoCorrection.pri \
...
Makefile: IntervalGenetic.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
